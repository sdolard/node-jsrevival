...
JsRevivalApp = function(){
    ...
    this.reporterName = 'cli-colored'; // default reporter
...
JsRevivalApp.displayHelp = function() {
    console.log('jsrevival [-j jslint_file] [-o jslint_options_file] [-s] [–m] [–v] [-R] [–q] [-p prefef] [-r reporterName] [–h] files directories ... ');
    ...
    console.log('  r: reporter (default: cli-colored)');
    console.log('     reporter list:');
    console.log('      - cli-colored');
    console.log('      - cli');
};
...
JsRevivalApp.prototype = {
    ...
    getProcessParams: function() {
        ...
        optParser = new getopt.BasicParser(':hRvmqsj:p:o:r:', process.argv);
